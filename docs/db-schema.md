...
| `channelSettings` | Per-channel orchestration settings. `id` equals the channel's `parentChats.id` (1:1). | `id`, `description`, `systemPrompt`, `maxChainedSubTurns`, `chainFollowupMode`, `maxMessagesPerAgentPerInput`, `tokenBudgetPerInput`, `allowAgentThreading`, `createdAt`, `updatedAt` | none |
